...
import { useFavPokemonList } from "@/store/useFavPokemonList";
import { FavPokemon } from "@/types/pokeTypes";
import { HeartOff } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

export default function FavPokemonCard({ pokemon }: { pokemon: FavPokemon }){
